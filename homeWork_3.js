...
let firstChar = phrase2.substring(0, 1).toUpperCase()
let secondChar = phrase2.substring(3, 4).toUpperCase()
let thirdChar = phrase2.substring(8, 9).toUpperCase()
let fourthChar = phrase2.substring(12, 13).toUpperCase()
let abbreviation = firstChar.concat(secondChar, thirdChar, fourthChar)
